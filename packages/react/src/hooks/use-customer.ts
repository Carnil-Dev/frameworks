...
export function useCustomer(customerId?: string): UseCustomerReturn {
  ...
  const createCustomer = useCallback(async (request: CreateCustomerRequest): Promise<CarnilResponse<Customer>> => {
  ...
  const updateCustomer = useCallback(async (id: string, request: UpdateCustomerRequest): Promise<CarnilResponse<Customer>> => {
    setState(prev => ({ ...prev, isLoading: true, error: null }));
  ...
  const deleteCustomer = useCallback(async (id: string): Promise<CarnilResponse<void>> => {
    setState(prev => ({ ...prev, isLoading: true, error: null }));
  ...
  const fetchCustomer = useCallback(async (id: string): Promise<CarnilResponse<Customer>> => {
    setState(prev => ({ ...prev, isLoading: true, error: null }));
  ...
  const listCustomers = useCallback(async (request?: CustomerListRequest): Promise<CarnilResponse<ListResponse<Customer>>> => {
    setState(prev => ({ ...prev, isLoading: true, error: null }));
